...
{
	printf("Capteur %s connecté",idCapteur);
	system ("./client localhost 5005 \"{\\\"idCapteur\\\":\\\"capteur\\\",\\\"commande\\\":\\\"deccrocherCapteur\\\"}\"");
